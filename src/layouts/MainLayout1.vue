<template>
  <div :class="{ dark: isDark }" class="root">
    ...
    <nav class="nav-links">
      ...
      <router-link class="button" :to="{ name: 'news' }">Новости мира биткоина</router-link>
      <router-link class="button" :to="{ name: 'users' }">Зал славы кликеров </router-link>
      <router-link class="button" :to="{ name: 'authorization' }">Авторизация на сайте</router-link>
    </nav>
    <slot />
...
.main.light-theme {
  background: url(https://static.wixstatic.com/media/d20c7a_8bbfbb01298346b9b4c776070becf78a~mv2.jpg/v1/fill/w_1920,h_1280,al_c,q_90,usm_0.66_1.00_0.01,enc_avif,quality_auto/d20c7a_8bbfbb01298346b9b4c776070becf78a~mv2.jpg)
    no-repeat;
  background-size: cover;
}
.main.dark-theme {
  background: url(https://avatars.mds.yandex.net/i?id=d765ee81ac38a484ce1b1c92a96808ca_l-3006166-images-thumbs&n=13)
    no-repeat;
  background-size: cover;
}
.nav-links {
